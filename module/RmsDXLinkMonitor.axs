 ...
 *     as applicable.
*/
MODULE_NAME='RmsDXLinkMonitor'(DEV vdvRMS,
...
CHAR MONITOR_ASSET_TYPE[] = 'DXLink Device';
...
DEFINE_FUNCTION RegisterAsset(RmsAsset asset)
{
  ...
  asset.name        = 'DXLink Device';
  asset.description = 'DXLink device';
  asset.assetType   = 'AMX peripheral';	
