...
integer DEV_ID_VIRTUAL_MONITOR_LEFT      = 41002
integer DEV_ID_VIRTUAL_MONITOR_RIGHT     = 41003
integer DEV_ID_VIRTUAL_DRAG_AND_DROP_10  = 33001
...
// PTZ Camera
dvPtzCam    = DEV_ID_DVX_CONTROLLER:PORT_DVX_IR_1:SYS_MASTER
...
// Lighting
dvLightingSystem  = DEV_ID_MASTER:2:SYS_MASTER // This device should be used as the physical device by the COMM module
vdvLightingSystem = DEV_ID_VIRTUAL_LIGHTING:PORT_VIRTUAL_MAIN:SYS_MASTER  // The COMM module should use this as its duet device

// IP socket for wake on lan
dvIpSocketWakeOnLan = DEV_ID_MASTER:3:SYS_MASTER

// Monitors
dvMonitorLeft   = DEV_ID_DVX_CONTROLLER:PORT_DVX_SERIAL_2:SYS_MASTER
vdvMonitorLeft  = DEV_ID_VIRTUAL_MONITOR_LEFT:PORT_VIRTUAL_MAIN:SYS_MASTER
dvMonitorRight  = DEV_ID_DVX_CONTROLLER:PORT_DVX_SERIAL_1:SYS_MASTER
vdvMonitorRight = DEV_ID_VIRTUAL_MONITOR_RIGHT:PORT_VIRTUAL_MAIN:SYS_MASTER

// RMS
vdvRms  = DEV_ID_VIRTUAL_RMS:PORT_VIRTUAL_MAIN:SYS_MASTER

// drag-and-drop
vdvDragAndDrop10 = DEV_ID_VIRTUAL_DRAG_AND_DROP_10:PORT_VIRTUAL_MAIN:SYS_MASTER
vdvDragAndDrop19 = DEV_ID_VIRTUAL_DRAG_AND_DROP_19:PORT_VIRTUAL_MAIN:SYS_MASTER
