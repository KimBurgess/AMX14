...
initArea (dragAreas10[dvDvxVidInTableHdmi1.port], 40, 40 ,133, 200)
initArea (dragAreas10[dvDvxVidInTableHdmi2.port], 627, 40, 133, 200)
initArea (dragAreas10[dvDvxVidInTableVga.port], 40, 1040, 133, 200)
initArea (dragAreas10[dvDvxVidInTableDisplayPort.port], 627, 1040, 133, 200)
...
blockDraggablePopups10[dvDvxVidInTableDisplayPort.port] = "'block-',draggablePopups10[dvDvxVidInTableDisplayPort.port]"
blockDraggablePopups10[dvDvxVidInTableHdmi1.port]       = "'block-',draggablePopups10[dvDvxVidInTableHdmi1.port]"
blockDraggablePopups10[dvDvxVidInTableHdmi2.port]       = "'block-',draggablePopups10[dvDvxVidInTableHdmi2.port]"
blockDraggablePopups10[dvDvxVidInTableVga.port]         = "'block-',draggablePopups10[dvDvxVidInTableVga.port]"
